...
// console.log(d += 10); //Uncaught TypeError: Assignment to constant variable.
...
//
// Our program is located in ${program.location}. The program is ${program.length}.
// The program covers ${program.technology}!`
