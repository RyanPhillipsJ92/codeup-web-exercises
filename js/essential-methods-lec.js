...
// });
    ...
    $('#lock-g').click(function(e){
        ...
        if($('#gryffindor-house').hasClass('gryffindor')){
            $(this).text('Unlock');
            $('#gryffindor-house').css('background-color','red');
        }else {
            $(this).text('Lock In');
            $('#gryffindor-house').css('background-color','');
        }
    });
    ...
    $('#lock-s').click(function(e) {
        ...
        if($('#slytherin-house').hasClass('slytherin')){
            $(this).text('Unlock');
            $('#slytherin-house').css('background-color','green');
        }else {
            $(this).text('Lock In');
            $('#slytherin-house').css('background-color','');
        }
    });
    ...
    $('#lock-r').click(function(e) {
        ...
        if($('#ravenclaw-house').hasClass('ravenclaw')){
            $(this).text('Unlock');
            $('#ravenclaw-house').css('background-color','yellow');
        }else {
            $(this).text('Lock In');
            $('#ravenclaw-house').css('background-color','yellow');
        }
    ...
    $('#lock-h').click(function(e) {
        ...
        if($('#hufflepuff-house').hasClass('hufflepuff')){
            $(this).text('Unlock');
            $('#hufflepuff-house').css('background-color','pink');
        }else {
            $(this).text('Lock In');
            $('#hufflepuff-house').css('background-color','pink');
        }
