...
function startsWithVowel(string){
    var startWith = string.charAt(0);
    if(isVowel(startWith)){
        return true;
    }
    else return false;
}
...
function endsWithVowel(string){
    var endWith = string.charAt(string.length - 1);
    if(isVowel(endWith)){
        return true;
    }
    else return false;
...
function startsAndEndsWithVowel(string){
    var startWith = string.charAt(0);
    var endWith = string.charAt(string.length - 1);
    if(isVowel(startWith) && isVowel(endWith)){
        return true;
    }
    else return false;
}
...
function firstToLast(array){
    var takeOut = array.shift();
    var putIn = array.push(takeOut);
    return array;
...
function totalOfBookPrices(array){
    var sum = 0;
    for (var i = 0; i < array.length; i++) {
        sum = sum + totalOfBookPrices[i].price
    }
    return sum;
}
